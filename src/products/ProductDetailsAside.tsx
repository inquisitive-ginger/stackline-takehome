...
const ProductDetailsAside = ({ product }: Props) => {
  return (
    <section className="w-full md:min-w-[300px] md:max-w-[300px] xl:min-w-[350px] xl:max-w-[350px] shadow-md p-4 md:p-0 md:py-4 flex flex-col sm:flex-row md:flex-col items-center sm:align-middle md:items-center bg-white">
